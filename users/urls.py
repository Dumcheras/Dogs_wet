...
from users.views import user_register_view, user_login_view, user_profile_view, user_update_view, \
    user_change_password_view, user_logout_view, user_generate_new_password
...
urlpatterns = [
    ...
    path('profile/change_password/', user_change_password_view, name='user_change_password'),
